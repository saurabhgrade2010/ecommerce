				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php
							include_once("db.php");
							$x=1;
							$orders_list = "SELECT o.order_date,o.order_id,o.user_id,o.product_id,o.qty,o.trx_id,o.STATUS,p.product_title,p.product_price,p.product_image FROM orders o,products p WHERE o.product_id=p.product_id and o.STATUS='$x' ORDER BY o.order_date DESC";
											...
											<div class="col-md-6">
												<table>
													 ...
													 <tr><td>Transaction Id</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
													  <tr><td>Date</td><td><b><?php echo DATE($row["order_date"]); ?></b></td></tr>
