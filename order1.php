		...
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				...
				<li><div class='panel-heading'>
						...
						<a href="order3.php" style="color:#333; list-style:none;"><button class="btn btn-success">Order cancel</button></a>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php
							include_once("db.php");
							$x=0;
							$orders_list = "SELECT o.order_id,o.user_id,o.product_id,o.order_date,o.qty,o.trx_id,o.STATUS,p.product_title,p.product_price,p.product_image FROM orders o,products p WHERE o.product_id=p.product_id and o.STATUS='$x'and o.confirm=0";
								...
								while ($row=mysqli_fetch_array($query)) {
									...
									?>
										<div class="row">
									       ...
									       <?php  
                      echo  "<button pid='$pid' style='float:right;' id='confirm_form' class='btn btn-danger btn-xs'>confirm</button>"; 
					   echo "   ";
                       							   
                      echo  "<button pid='$pid' style='float:right;' id='not_confirm_form' class='btn btn-danger btn-xs'>Not Confirm</button>"; 
											?>
